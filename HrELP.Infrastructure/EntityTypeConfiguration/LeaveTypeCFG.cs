    ...
    public class LeaveTypeCFG:BaseEntityConfiguration<LeaveType>
    {
        public override void Configure(EntityTypeBuilder<LeaveType> builder)
        {
            ...
            builder.HasData(
                ...
                new LeaveType { LeaveTypeId=14,LeaveTypeName="Adoption Leave",DayValue=40,MarriageStatus=true},
                new LeaveType { LeaveTypeId=15,LeaveTypeName="Milk Leave",DayValue=40,Gender=Domain.Entities.Enums.Gender.Female},
                new LeaveType { LeaveTypeId=16,LeaveTypeName="New Job Leave",DayValue=0.5M,Gender=Domain.Entities.Enums.Gender.Female},
                new LeaveType { LeaveTypeId=17,LeaveTypeName="New Job Leave",DayValue=0.5M,Gender=Domain.Entities.Enums.Gender.Male}
